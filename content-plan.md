...
This index introduces documentation navigation for the hosting example. Existing
product specifications remain under `specs/`; this is not a whole-repository audit.

| Area | Tier | Status | Path |
|---|---|---|---|
| Existing architecture | T1 | Existing, hosting supplement linked | specs/architecture.md |
| Hosting guide | T1 | Written | docs/hosting.md |
