...
import { addMember, formatDeleteMemberMessage } from "@/domain/members";
...
describe("MembersPanel", () => {
  ...
  it("edits a member name and avatar", async () => {
    ...
    const avatarPicker = screen.getByText("Style").closest(".avatar-picker")!;
  ...
  it("requires confirmation before deleting a member", async () => {
    ...
    expect(screen.getByText(formatDeleteMemberMessage("Emma"))).toBeTruthy();
